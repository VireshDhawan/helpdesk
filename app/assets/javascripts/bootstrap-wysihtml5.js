!function($, wysi) {
    ...
    var tpl = {
        ...
        "link": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal modal-styled fade'>" +
              "<div class='modal-dialog'>" +
                ...
                "<div class='modal-body'>" +
                  "<input value='http://' class='bootstrap-wysihtml5-insert-link-url' size='60'>" +
                  "<p> Enter the absolute url (your link must include <b>'http://'</b>) </p>" +
        ...
        "image": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal modal-styled fade'>" +
              "<div class='modal-dialog'>" +
                "<div class='modal-content'>" +
                "<div class='modal-header'>" +
                  "<a class='close' data-dismiss='modal'>&times;</a>" +
                ...
                "</div>" +
                "<div class='modal-body'>" +
                  "<input value='http://' class='bootstrap-wysihtml5-insert-image-url' size='60'><br/>" +
                  "<p> Enter the absolute url (your link to image must include <b>'http://'</b>) </p>" +
                "</div>" +
                "<div class='modal-footer'>" +
